            ...
            \{staff.map((staffMember) => (\
              <div key=\{staffMember.id\} className="flex items-center justify-between py-2 border-b">\
                <div className="font-medium">\
                  \{staffMember.name\}\
                  \{staffMember.shifts > 1 && <span className="ml-1 text-xs bg-blue-100 px-1 rounded">\'d7\{staffMember.shifts\}</span>\}\
                </div>\
                <button\
            ...
            \{items.map((item) => (\
              <div key=\{item.id\} className="flex items-center justify-between py-2 border-b">\
                <div>\
                  ...
                  <div className="text-sm text-gray-500">\uc0\u8377 \{item.price\}/\{item.unit\}</div>\
                </div>\
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">\
              <div className="bg-blue-50 p-3 rounded">\
                ...
                <div className="text-xl font-semibold">\
                  \uc0\u8377 \{calculateTotalSalary().toFixed(2)\}\
                </div>\
              </div>\
              <div className="bg-green-50 p-3 rounded">\
                <div className="text-sm text-gray-500">Items Cost</div>\
                <div className="text-xl font-semibold">\
                  \uc0\u8377 \{calculateTotalItemsCost().toFixed(2)\}\
                </div>\
              </div>\
            </div>\
            \
            ...
            <div className="border-t pt-4 mt-2">\
              ...
              <div className="p-3 bg-gray-50 rounded-lg">\
                    ...
                    \{staff.map(staffMember => \{\
                      ...
                      return (\
                        <div key=\{staffMember.id\} className="flex justify-between text-sm">\
                          ...
                          <span className="font-medium">\uc0\u8377 \{staffSalary.toFixed(2)\}</span>\
                        </div>\
                      );\
                    \})\}\
                    <div className="flex justify-between pt-1 border-t font-medium">\
                      <span>Total Staff</span>\
                      <span>\uc0\u8377 \{monthToDateData.staffCost.toFixed(2)\}</span>\
                    </div>\
                  </div>\
                </div>\
                \
                    ...
                    \{items.map(item => \{\
                      ...
                      return (\
                        <div key=\{item.id\} className="flex justify-between text-sm">\
                          ...
                          <span className="font-medium">\uc0\u8377 \{itemCost.toFixed(2)\}</span>\
                        </div>\
                      );\
                    \})\}\
                    <div className="flex justify-between pt-1 border-t font-medium">\
                      <span>Total Items</span>\
                      <span>\uc0\u8377 \{monthToDateData.itemsCost.toFixed(2)\}</span>\
                    </div>\
                  </div>\
                </div>\
                \
                ...
                <div className="flex justify-between font-bold text-lg pt-2 border-t border-gray-400">\
                  ...
                  <span>\uc0\u8377 \{(monthToDateData.staffCost + monthToDateData.itemsCost).toFixed(2)\}</span>\
                </div>\
              </div>\
            </div>\
          </div>\
        ...
        <div className="bg-white p-3 rounded-lg shadow">\
          ...
          <div className="p-3 bg-gray-50 rounded mb-4">\
            ...
            <div className="flex items-center mb-2">\
              <span className="mr-2">Salary: \uc0\u8377 </span>\
              <input\
                type="number"\
            ...
            \{staff.map((staffMember) => (\
              <div key=\{staffMember.id\} className="p-3 border rounded">\
                ...
                <div className="grid grid-cols-2 gap-2 text-sm mt-2">\
                  <div>\
                    <label className="block text-gray-600">Salary (\uc0\u8377 )</label>\
                    <input\
                      type="number"\
            ...
            <div className="space-y-2">\
              \{staff.map((staffMember) => (\
                <div key=\{staffMember.id\} className="flex justify-between items-center py-2 border-b">\
                  ...
                  <div className="font-semibold">\uc0\u8377 \{(staffMember.salary * staffMember.shifts).toFixed(2)\}</div>\
                </div>\
              ))\}\
              <div className="pt-2 flex justify-between items-center font-bold">\
                <div>Total</div>\
                <div>\uc0\u8377 \{staff.reduce((sum, s) => sum + (s.salary * s.shifts), 0).toFixed(2)\}</div>\
              </div>\
            </div>\
          </div>\
        </div>\
      ...
      \{activeTab === 'items' && (\
        <div className="bg-white p-3 rounded-lg shadow">\
          ...
          <div className="p-3 bg-gray-50 rounded mb-4">\
            ...
            />\
            <div className="flex items-center mb-2">\
              <span className="mr-2">Price: \uc0\u8377 </span>\
              <input\
                type="number"\
          ...
          <div className="space-y-2">\
            \{items.map((item) => (\
              <div key=\{item.id\} className="p-3 border rounded">\
                ...
                <div className="grid grid-cols-2 gap-2 text-sm mt-2">\
                  <div>\
                    <label className="block text-gray-600">Price (\uc0\u8377 )</label>\
                    <input\
                      type="number"\
                      value=\{item.price\}\
                      onChange=\{(e) => \{\
              ...
              <div className="space-y-2">\
                \{items.map((item) => (\
                  <div key=\{item.id\} className="flex justify-between items-center py-1 border-b text-sm">\
                    <div>\{item.name\}</div>\
                    <div>\uc0\u8377 \{item.price\} per \{item.unit\}</div>\
                  </div>\
                ))\}\
              </div>\
